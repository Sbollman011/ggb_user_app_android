package com.tv.GreenGrubBox.utils.Views;
...
public abstract class EndlessRecyclerScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void setVISIBLE_THRESHOLD(long VISIBLE_THRESHOLD) {
     ...
     */
    private   long VISIBLE_THRESHOLD = 6;
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        Logger.logsError(TAG,"START-------------------------------");
        Logger.logsError(TAG,"VISIBLE_THRESHOLD : " + VISIBLE_THRESHOLD);
        Logger.logsError(TAG,"visibleItemCount : " + visibleItemCount);
        Logger.logsError(TAG,"totalItemCount : " + totalItemCount);
        Logger.logsError(TAG,"firstVisibleItem : " + firstVisibleItem);
        Logger.logsError(TAG,"END-------------------------------");*/
