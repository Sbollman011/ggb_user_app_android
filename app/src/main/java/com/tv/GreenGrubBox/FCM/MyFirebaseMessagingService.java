package com.tv.GreenGrubBox.FCM;
...
//                scheduleJob();
    ...
    private void sendNotification(String messageBody) {
        Logger.logsError(TAG,"sendNotification called");
        Intent intent = new Intent(this, NewMainViewScreenActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra(Constant.TO_ACCOUNT_SCREEN, true);
