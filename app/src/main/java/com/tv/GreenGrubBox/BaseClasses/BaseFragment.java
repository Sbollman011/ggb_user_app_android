...
public abstract class BaseFragment extends Fragment implements MvpView {
    ...
    public void startActivityMidFlipAnimation(){
    ...
    public void startActivityVerticalAnimation(){
        ...
        getActivity().overridePendingTransition(R.anim.anim_slide_in_top,
    ...
    public void showLoadingGif() {
        hideLoading();
        mProgressDialog = CommonUtils.showLoadingDialogGIF(this.getContext());
    }
