...
public class VendorMapPresenter<V extends VendorMapMvpView, I extends VendorMapMvpInteractor> extends
        BasePresenter<V, I> implements VendorMapMvpPresenter<V, I> {


    private static final String TAG = VendorMapPresenter.class.getSimpleName();

    @Inject
    public VendorMapPresenter(I mvpInteractor, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable) {
